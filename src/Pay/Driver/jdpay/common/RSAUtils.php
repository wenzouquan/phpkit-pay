<?php
namespace phpkit\pay\Pay\Driver\jdpay\common;
class RSAUtils {

	public static function encryptByPrivateKey($data) {

		$pi_key = openssl_pkey_get_private(file_get_contents(dirname(dirname(__FILE__)) . '/config/seller_rsa_private_key.pem')); //这个函数可用来判断私钥是否是可用的，可用返回资源id Resource id
